...
module speccy48_tb_top (
    ...
    output wire [7:0]  dbg_pg0,     // 0x4001 -> vram[0x0001] (paging probe)
    output wire [7:0]  dbg_pg1,     // 0x4002 -> vram[0x0002]
    output wire [7:0]  dbg_exec,    // 0x4003 -> vram[0x0003] (exec-from-RAM)
    ...
    speccy48 #(.ROM_FILE("sim/cpu_rom.hex"),
               .ROM128_FILE("sim/cpu_rom.hex")) u_ss (   // both ROMs = smoke
        .clk          (clk),
        .rst          (rst),
        .divmmc_en    (1'b0),
        .en_128       (en_128),
    ...
    assign dbg_pg0    = u_ss.u_machine.u_vram.mem[14'h0001];
    assign dbg_pg1    = u_ss.u_machine.u_vram.mem[14'h0002];
    assign dbg_exec   = u_ss.u_machine.u_vram.mem[14'h0003];
